...
namespace the_kitchen_aspnet_core.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategotyId,Name,Timestamp")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategotyId,Name,Timestamp")] Category category)
        {
